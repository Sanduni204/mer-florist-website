...
<style>
  ...
  .admin-nav a { padding: 10px 14px; border:none; border-radius:8px; background:#fff; }
  .admin-card { background:#fff; border:none; border-radius:12px; padding:20px; box-shadow:none; }
